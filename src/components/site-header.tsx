...
export function SiteHeader() {
  return (
    <header className="relative z-20 border-b border-line/80 bg-panel/78 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <ThemeToggle />
          <Link href="/search" className="rounded-full bg-accent px-3 py-2 text-sm font-semibold text-slate-950 transition hover:bg-accent-strong sm:px-4">Start search</Link>
        </div>
      </div>
      <div className="no-scrollbar overflow-x-auto border-t border-line/60 md:hidden">
