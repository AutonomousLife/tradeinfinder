    ...
    <header className="relative z-20 border-b border-line/80 bg-panel/80 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-4">
        ...
        <div className="flex items-center gap-3">
          <ThemeToggle />
          <Link href="/search" className="rounded-full border border-line bg-accent px-4 py-2 text-sm font-semibold text-slate-950 transition hover:-translate-y-0.5 hover:bg-accent-strong">Start search</Link>
        </div>
      </div>
    </header>
  );
